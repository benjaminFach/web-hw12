...
public class BookingDay {
    ...
    //    System.out.println("utils.BookingDay(" + year +"," + month + "," + dayOfMonth + ")");
        this.year = year;
        this.month = month - 1;
...
//        System.out.println("getDate(" + year + "," + month + "," + dayOfMonth + "0");
    ...
    /** Set the year of this date.  This invalidates the utils.BookingDay object,
